...
const CFG_TOOLTIPS = {
  ...
  KRAKEN_POST_JOIN_WAIT_SECONDS: 'Settle wait after joining the fight, before weapon prep. Default 1s.',
  ...
  ZYTOS_POST_JOIN_WAIT_SECONDS: 'Settle wait after joining the Zytos fight, before weapon prep. Default 1s.',
...
const MODE_SETTINGS_TABS = {
  ...
  zytos: [
    ...
    {id:'finetuning', label:'Fine-Tuning', sections:[
      {title:'Kill Detection',keys:['ZYTOS_HB_CONFIRM_WINDOW_SECONDS','ZYTOS_POST_HB_LOSS_SHOOT_SECONDS','ZYTOS_HEALTH_BAR_FIRST_SEEN_TIMEOUT_SECONDS']},
