...
KRAKEN_POST_JOIN_WAIT_SECONDS = float(_cfg.get("KRAKEN_POST_JOIN_WAIT_SECONDS", DELVE_POST_JOIN_WAIT_SECONDS))
...
ZYTOS_HB_CONFIRM_WINDOW_SECONDS = float(_cfg.get("ZYTOS_HB_CONFIRM_WINDOW_SECONDS", 2.5))
ZYTOS_POST_KILL_WAIT_SECONDS = float(_cfg.get("ZYTOS_POST_KILL_WAIT_SECONDS", 0.0))
ZYTOS_REWARD_OPEN_WAIT_SECONDS = float(_cfg.get("ZYTOS_REWARD_OPEN_WAIT_SECONDS", 1.0))
ZYTOS_HB_EXTENDED_WINDOW_SECONDS = float(_cfg.get("ZYTOS_HB_EXTENDED_WINDOW_SECONDS", 5.0))
