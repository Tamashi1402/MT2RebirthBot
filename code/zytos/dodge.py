# ============================================================
# ZYTOS - movement-key cleanup (own module, not kraken_dodge)
# ============================================================
_MOVEMENT_VKS = (0x57, 0x41, 0x53, 0x44)


def stop_zytos_dodge(wait: bool = True, timeout: float = 2.5):
    """Release movement keys left over from zytos walk/strafe."""
    ...
    try:
        ...
        pass
    try:
        from .input import release_movement_keys
